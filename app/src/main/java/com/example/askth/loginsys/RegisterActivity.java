...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputEditText coordinates;
    ...
    private void initViews() {
        ...
        coordinates = (TextInputEditText) findViewById(R.id.coordinates);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            {String coords=coordinates.getText().toString();
                ...
                MapsActivity2 ob=new MapsActivity2();
                ob.addElement(lat,lon);
                postDataToSQLite();
                break;}
